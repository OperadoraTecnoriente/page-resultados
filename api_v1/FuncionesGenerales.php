...
$cod_agencia_length = 6;
$nombre_agencia_length = 50;
$responsable_length = 20;
$telefono_length = 20;
$direccion_length = 20;
$correo_length = 30;
$clave_agencia_length = 20;
$numero_de_cuenta_length = 20;
$codigo_banco_length = 4;
$pagomovil_length = 11;
$cedula_length = 30;
$cod_grupo_length = 4;
$cod_sorteo_length = 4;
$numero_taquilla_length = 1;
$serial_registro_length = 200;
$numero_ticket_length = 10;
$num_ref_length = 20;
$monto_length = 18;
$jugada_length = 8;
$dupleta_length = 3;
$cod_referencia_length = 6;
$mensaje_final_length = 50;

/*
if ((isset($_POST['sorteo']) && validar_int($_POST['sorteo']) &&  strlen($_POST['sorteo']) == $cod_sorteo_length) || $_POST['sorteo'] == "%") {
if (isset($_POST['fecha']) && validarFecha($_POST['fecha'])) {
if (isset($_POST['status']) &&  $_POST['status'] == "1" || $_POST['status'] == "2" || $_POST['status'] == "3" || $_POST['status'] == "4") {
...
function validarFecha($fecha)
{
    ...
    return preg_match($regexFecha, $fecha);
}
